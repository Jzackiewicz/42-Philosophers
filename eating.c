...
/*   Updated: 2025/02/26 20:11:51 by jzackiew         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	leave_forks(pthread_mutex_t *first_fork, pthread_mutex_t *second_fork)
{
	pthread_mutex_unlock(first_fork);
	pthread_mutex_unlock(second_fork);
}

static void	eat_with_forks(t_philo_data *philo_data, pthread_mutex_t *first_fork,
		pthread_mutex_t *second_fork)
{
